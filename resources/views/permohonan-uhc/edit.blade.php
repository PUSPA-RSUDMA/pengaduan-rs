    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form action="{{ route('permohonan-uhc.update', $permohonan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="text" name="segmen_kepesertaan" class="form-control" value="{{ $permohonan->segmen_kepesertaan }}" required>
                        </div>

                        <div class="col-md-12 mb-2">
                            <label class="form-label fw-semibold small">Alasan Peralihan <span class="text-danger">*</span></label>
                            <textarea name="alasan_peralihan" class="form-control" rows="4" required>{{ $permohonan->alasan_peralihan }}</textarea>
                        </div>
                    ...
                    <div class="d-flex justify-content-between pt-3 border-top">
                        <a href="{{ route('permohonan-uhc.index') }}" class="btn btn-light border rounded-3 fw-medium">Kembali</a>
